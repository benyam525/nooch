          ...
          <form className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  className="h-4 w-4 rounded border-nooch-light text-coral-400 focus:ring-coral-400"
                />
                <span className="text-sm text-nooch-gray">Remember me</span>
              </label>
              <Link
          ...
          <div className="relative">
            ...
            <p className="mt-6 max-w-md text-lg text-gray-400">
              ...
              <span className="font-mono text-gray-300">
                Upload your methodology, let AI handle routine questions, approve before sending.
              </span>
            </p>
            ...
            <div className="mt-10 rounded-xl border border-white/10 bg-white/5 p-6 font-mono text-sm">
              <div className="mb-4 flex items-center gap-2">
                ...
                <span className="ml-2 text-gray-500">nooch_benefits.sh</span>
              </div>
              <div className="space-y-2 text-gray-300">
                <p>
                  <span className="text-coral-400">$</span> echo "Save 10+ hours per week"
                </p>
                <p>
                  <span className="text-coral-400">$</span> echo "Scale to 100+ clients"
                </p>
                <p>
                  <span className="text-coral-400">$</span> echo "Keep your personal touch"
                </p>
